...
enum soundID {DOOR, DOOR_KUTSCHFAHRT, CLICK, SKILL_ACQUIRED, INVENTORY_DROP, LOOTABLE_TAKE_ALL, DRINK, DAMAGE_OVER_TIME, CRITICAL_HIT, DODGED, BARREL, CABINET, CHEST, CUP, KEG, RUBBISH, SACK, SKELETON, STONEPILE, TABLE, WAGON, NUMBER_OF_SOUNDS};
