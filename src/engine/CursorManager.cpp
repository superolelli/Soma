...
void CursorManager::Init(CWindow * _window)
{
	...
	cursorNormal.emplace(cursorNormalImage.getPixelsPtr(), cursorNormalImage.getSize(), sf::Vector2u{0, 0});
	cursorHand.emplace(cursorHandImage.getPixelsPtr(), cursorHandImage.getSize(), sf::Vector2u{0, 0});
