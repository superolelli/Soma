...
void LevelFinishedPanel::UpdatePositions()
{
	...
	levelFinishedText.setPosition(sf::Vector2f(330, 230));
	unlockedItemsText.setPosition(sf::Vector2f(1410, 220));
	rewardDescriptionText.setPosition(sf::Vector2f(330, 360));
	rewardCardsText.setPosition(sf::Vector2f(1070, 360));
	rewardDiceText.setPosition(sf::Vector2f(1260, 360));
	rewardFinalCardsText.setPosition(sf::Vector2f(430, 880));
	rewardFinalDiceText.setPosition(sf::Vector2f(920, 880));
}
