...
{
	diceAmountText.setPosition(sf::Vector2f(statusBar.GetGlobalRect().position.x + 80, statusBar.GetGlobalRect().position.y + 20));
	cardsAmountText.setPosition(sf::Vector2f(statusBar.GetGlobalRect().position.x + 150, statusBar.GetGlobalRect().position.y + 20));
}
