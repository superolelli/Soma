...
{
	enemyContext->notificationRenderer->AddNotification("Verwirrt!", g_pFonts->f_blackwoodCastle, sf::Vector2f(enemyContext->GetRect().position.x + enemyContext->GetRect().size.x / 2.0f, enemyContext->GetRect().position.y - 20.0f), 1.0f);
