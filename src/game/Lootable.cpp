...
{
	sprite.SetPos(_x, _y);
	currentBoundingBox.position.x = _x + g_pObjectProperties->lootableProperties[id].boundingBox.position.x;
	currentBoundingBox.position.y = _y + g_pObjectProperties->lootableProperties[id].boundingBox.position.y;
}
