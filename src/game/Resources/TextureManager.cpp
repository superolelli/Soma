...
void CTextureManager::LoadTextures()
{
	...
	std::vector<std::string> firstBackgrounds[2] = {
		{
			...
			"Data/Sprites/Backgrounds/Bang/bang_gang_door_1.png",
			"Data/Sprites/Backgrounds/Bang/bang_gang_door_2.png",
	...
	bangDoor.loadFromFile("Data/Sprites/Backgrounds/Bang/bang_gang_door.png");
	...
	std::vector<std::string> itemStrings = {
		{
			...
			"Data/Sprites/Items/Kutschfahrt/broken_mirror.png",
	...
	bounty.loadFromFile("Data/Sprites/Battle/bounty.png");
