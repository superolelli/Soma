...
void ObjectPropertiesManager::LoadLootableProperties()
{
	...
	for (xml_node &lootable : doc.child("Lootables").children())
	{
		...
		lootableProperties[lootableID].boundingBox.position.x = lootable.child("boundingBox").child("left").text().as_int();
		lootableProperties[lootableID].boundingBox.position.y = lootable.child("boundingBox").child("top").text().as_int();
		lootableProperties[lootableID].boundingBox.size.x = lootable.child("boundingBox").child("width").text().as_int();
		lootableProperties[lootableID].boundingBox.size.y = lootable.child("boundingBox").child("height").text().as_int();
